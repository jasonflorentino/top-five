defmodule HelloExWeb.GameLobbyComponent do
      ...
      <form phx-submit="add_game_item" class="flex flex-col gap-2 w-full">
        <div class="flex flex-col gap-1">
          ...
          <div class="flex gap-2">
            <input id="item_name" name="item_name" type="text" autocomplete="off" class="w-3/4 rounded bg-gray-800/80 hover:bg-gray-700/50 focus:bg-gray-700/50" />
    ...
    <section id="players" class="mt-6 p-3 bg-gray-900 rounded-lg ">
      ...
      <form phx-submit="set_player_name" class="flex flex-col gap-2 w-full">
        <div class="flex flex-col gap-1">
          ...
          <div class="flex gap-2">
            <input id="player_name" name="player_name" type="text" autocomplete="off" class="w-3/4 rounded bg-gray-800/80 hover:bg-gray-700/50 focus:bg-gray-700/50" />
            <button class="w-1/4 px-3 py-3 rounded-md font-semibold bg-blue-600 text-blue-50 hover:bg-blue-700">Submit</button>
          </div>
        </div>
      </form>
        ...
        <form phx-submit="set_game_status">
          ...
          <button disabled={length(@items) < 5 || length(@users) < 2} class="px-5 py-3 rounded-md font-semibold bg-green-600 text-green-50 hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-green-600">Start Game</button>
        </form>
      </nav>
